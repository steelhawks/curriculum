...
My bad! I got a little carried away with the formatting. Here are those constructor questions swapped into the specific <Quiz /> tag format you've been using:
